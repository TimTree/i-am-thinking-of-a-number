...
function imdone() {
document.getElementById("main").innerHTML="<div id='darkMode' onclick='dark()'></div><h1>I am Thinking of a Number.</h1><div class='block'><button class='big' type='button' onclick='between()'>Begin</button><div id='titleselect'><ul><li><button type='button' onclick='help()'>Help</button></li><li><button type='button' onclick='about()'>About</button></li></ul></div></div><div id='copyright'>Version 3.1 &nbsp;&#126;&nbsp; &copy;2010-2020 Timothy Hsu<em></em></div>";
}